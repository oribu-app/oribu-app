...
class HltbService {
    ...
    fun search(query: String): List<HltbResult> {
        ...
        val payload = """{"searchType":"games","searchTerms":["${query.replace(
            "\"",
            "",
        )}"],"searchPage":1,"size":5,"searchOptions":{"games":{"userId":0,"platform":"","sortCategory":"popular","rangeCategory":"main","rangeTime":{"min":null,"max":null},"gameplay":{"perspective":"","flow":"","genre":"","subgenre":""},"rangeYear":{"min":"","max":""},"modifier":""},"users":{"sortCategory":"postcount"},"lists":{"sortCategory":"follows"},"filter":"","sort":0,"randomizer":0}}"""
        return try {
            val req =
                Request
                    .Builder()
    ...
    private fun mapResult(r: Map<String, Any?>) =
        HltbResult(
